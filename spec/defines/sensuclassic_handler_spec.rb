...
describe 'sensuclassic::handler', :type => :define do
  ...
  context 'default (present)' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with(
      :ensure      => 'present',
  ...
  context 'absent' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_ensure('absent') }
    it do
  ...
  context 'command' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_command('/somewhere/file/script.sh') }
  end
  ...
  context 'source' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_command('/etc/sensu/handlers/script.sh') }
  end
  ...
  context 'source and command' do
    ...
    it { should contain_file('/etc/sensu/handlers/script.sh').with_ensure('file') }
    it { should contain_sensuclassic_handler('myhandler').with_command('script.sh') }
  end
  ...
  context 'exchange' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_exchange({'type' => 'topic'}) }
  end
  ...
  context 'tcp' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_socket({'host' => '192.168.23.23', 'port' => '2003'}) }
  end
  ...
  context 'transport' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_pipe({
      'type'    => 'topic',
      'name'    => 'events',
      'options' => {
        'passive' => 'true',
  ...
  context 'mutator' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_mutator('only_check_output') }
  end

  context 'config' do
    let(:params) { { :command => 'mycommand.rb', :config => {'param' => 'value'} } }

    it { should contain_sensuclassic_handler('myhandler').with_config( {'param' => 'value' } ) }
  end
  ...
  context 'timeout' do
    ...
    it { should contain_sensuclassic_handler('myhandler').with_timeout( 10 ) }
  end

  context 'handle_flapping' do
    let(:params) { { :command => 'mycommand.rb', :type => 'pipe', :handle_flapping => true } }
    it { should contain_sensuclassic_handler('myhandler').with_handle_flapping( true ) }
  end

  context 'handle_silenced' do
    let(:params) { { :command => 'mycommand.rb', :type => 'pipe', :handle_silenced => true } }
    it { should contain_sensuclassic_handler('myhandler').with_handle_silenced( true ) }
  end

  context 'handle_silenced set to false' do
    let(:params) { { :command => 'mycommand.rb', :type => 'pipe', :handle_silenced => false } }
    it { should contain_sensuclassic_handler('myhandler').with_handle_silenced( false ) }
  end
