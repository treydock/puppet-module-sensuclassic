...
describe 'sensuclassic::mutator', :type => :define do
  ...
  context 'default (present)' do
    ...
    it { should contain_sensuclassic_mutator('mymutator').with(
      :ensure      => 'present',
      :command     => '/etc/sensu/mutators/mycommand.rb'
    ) }
    it do
  ...
  context 'absent' do
    ...
    it { should contain_sensuclassic_mutator('mymutator').with_ensure('absent') }
    it do
      should contain_file("/etc/sensu/conf.d/mutators/#{title}.json").with(
        :ensure => 'absent'
      )
  ...
  context 'install path' do
    ...
    it { should contain_sensuclassic_mutator('mymutator').with_command('/etc/mycommand.rb') }
  end
  ...
  context 'command' do
    ...
    it { should contain_sensuclassic_mutator('mymutator').with_command('/somewhere/file/script.sh') }
  end
  ...
  context 'source' do
    ...
    it { should contain_sensuclassic_mutator('mymutator').with_command('/etc/sensu/mutators/script.sh') }
  end
