...
Puppet::Type.type(:sensuclassic_check).provide(:json) do
  confine :feature => :json
  include PuppetX::Sensuclassic::ToType
  include PuppetX::Sensuclassic::ProviderCreate

  SENSU_CHECK_PROPERTIES = Puppet::Type.type(:sensuclassic_check).validproperties.reject { |p| p == :ensure }
  ...
  # Generate setters and getters for sensuclassic_check properties.
